 ...
 *         2016.03.09.
 */
public class PlayerVehicleManager implements PlayerVehicleController {

    protected static final Collection<PlayerVehicle> playerVehiclesList = new ArrayList<>();
    private static final Logger logger = LoggerFactory.getLogger(PlayerVehicleManager.class);
