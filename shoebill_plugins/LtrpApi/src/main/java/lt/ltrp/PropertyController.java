...
public interface PropertyController {
    ...
    House createHouse(int id, String name, int ownerUserId, int pickupModelId, int price, Location entrance, Location exit, Color labelColor, EventManager eventManager);
    ...
    Garage createGarage(int id, String name, int ownerUserId, int pickupModelId, int price, Location entrance, Location exit, Location vehicleEntrance, Location vehicleExit,
