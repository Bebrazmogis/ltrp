...
public class Functions {
	...
	public static void registerFunctions(AmxInstance instance) {
		functions.put("ffind", instance.getNative("ffind", ReturnType.INTEGER));
		functions.put("frename", instance.getNative("frename", ReturnType.INTEGER));
		functions.put("dfind", instance.getNative("dfind", ReturnType.INTEGER));
		functions.put("dcreate", instance.getNative("dcreate", ReturnType.INTEGER));
		functions.put("drename", instance.getNative("drename", ReturnType.INTEGER));
		...
		functions.put("CreatePlayerPickup", instance.getNative("CreatePlayerPickup", ReturnType.INTEGER));
		functions.put("DestroyPlayerPickup", instance.getNative("DestroyPlayerPickup", ReturnType.INTEGER));
		functions.put("IsValidPlayerPickup", instance.getNative("IsValidPlayerPickup", ReturnType.INTEGER));
		functions.put("IsPlayerPickupStreamedIn", instance.getNative("IsPlayerPickupStreamedIn", ReturnType.INTEGER));
		functions.put("GetPlayerPickupPos", instance.getNative("GetPlayerPickupPos", ReturnType.INTEGER));
		functions.put("GetPlayerPickupModel", instance.getNative("GetPlayerPickupModel", ReturnType.INTEGER));
		functions.put("GetPlayerPickupType", instance.getNative("GetPlayerPickupType", ReturnType.INTEGER));
		functions.put("GetPlayerPickupVirtualWorld", instance.getNative("GetPlayerPickupVirtualWorld", ReturnType.INTEGER));
	...
	public static int ffind(String pattern, String filename, int len, ReferenceInt idx) {
		return (int) functions.get("ffind").call(pattern, filename, len, idx);
	}

	public static int frename(String oldname, String newname) {
		return (int) functions.get("frename").call(oldname, newname);
	}

	public static int dfind(String pattern, String filename, int len, ReferenceInt idx) {
		return (int) functions.get("dfind").call(pattern, filename, len, idx);
	}

	public static int dcreate(String name) {
		return (int) functions.get("dcreate").call(name);
	}

	public static int drename(String oldname, String newname) {
		return (int) functions.get("drename").call(oldname, newname);
	}
	...
	public static int GetFilterScriptName(int id, ReferenceString name, int lenname) {
		return (int) functions.get("GetFilterScriptName").call(id, name, lenname);
	}
	...
	public static int GetPlayerNameForPlayer(int playerid, int nameplayerid, ReferenceString playername, int sizeplayername) {
		return (int) functions.get("GetPlayerNameForPlayer").call(playerid, nameplayerid, playername, sizeplayername);
	}
	...
	public static int GetPlayerRaceCheckpoint(int playerid, ReferenceFloat fX, ReferenceFloat fY, ReferenceFloat fZ, ReferenceFloat fNextX, ReferenceFloat fNextY, ReferenceFloat fNextZ, ReferenceFloat fSize) {
		return (int) functions.get("GetPlayerRaceCheckpoint").call(playerid, fX, fY, fZ, fNextX, fNextY, fNextZ, fSize);
	}
	...
	public static int GetObjectMaterial(int objectid, int materialindex, ReferenceInt modelid, ReferenceString txdname, int txdnamelentxdname, ReferenceString texturename, int texturenamelentexturename, ReferenceInt materialcoor) {
		return (int) functions.get("GetObjectMaterial").call(objectid, materialindex, modelid, txdname, txdnamelentxdname, texturename, texturenamelentexturename, materialcoor);
	}

	public static int GetObjectMaterialText(int objectid, int materialindex, ReferenceString text, int textlentext, ReferenceInt materialsize, ReferenceString fontface, int fontfacelenfontface, ReferenceInt fontsize, ReferenceInt bold, ReferenceInt fontcolor, ReferenceInt backcolor, ReferenceInt textalignment) {
		return (int) functions.get("GetObjectMaterialText").call(objectid, materialindex, text, textlentext, materialsize, fontface, fontfacelenfontface, fontsize, bold, fontcolor, backcolor, textalignment);
	}
	...
	public static int GetPlayerObjectMaterial(int playerid, int objectid, int materialindex, ReferenceInt modelid, ReferenceString txdname, int txdnamelentxdname, ReferenceString texturename, int texturenamelentexturename, ReferenceInt materialcolor) {
		return (int) functions.get("GetPlayerObjectMaterial").call(playerid, objectid, materialindex, modelid, txdname, txdnamelentxdname, texturename, texturenamelentexturename, materialcolor);
	}

	public static int GetPlayerObjectMaterialText(int playerid, int objectid, int materialindex, ReferenceString text, int textlentext, ReferenceInt materialsize, ReferenceString fontface, int fontfacelenfontface, ReferenceInt fontsize, ReferenceInt bold, ReferenceInt fontcolor, ReferenceInt backcolor, ReferenceInt textalignment) {
		return (int) functions.get("GetPlayerObjectMaterialText").call(playerid, objectid, materialindex, text, textlentext, materialsize, fontface, fontfacelenfontface, fontsize, bold, fontcolor, backcolor, textalignment);
	}
	...
	public static int GetLocalIP(int index, ReferenceString localip, int lenlocalip) {
		return (int) functions.get("GetLocalIP").call(index, localip, lenlocalip);
	}
	...
	public static int GetVehicleNumberPlate(int vehicleid, ReferenceString plate, int lenplate) {
		return (int) functions.get("GetVehicleNumberPlate").call(vehicleid, plate, lenplate);
	}
	...
	public static int TextDrawGetString(int textdrawid, String text, int lentext) {
		return (int) functions.get("TextDrawGetString").call(textdrawid, text, lentext);
	}
	...
	public static int PlayerTextDrawGetString(int playerid, int textdrawid, String text, int lentext) {
		return (int) functions.get("PlayerTextDrawGetString").call(playerid, textdrawid, text, lentext);
	}
	...
	public static int Get3DTextLabelText(int id, String text, int lentext) {
		return (int) functions.get("Get3DTextLabelText").call(id, text, lentext);
	}
	...
	public static int GetPlayer3DTextLabelText(int playerid, int id, String text, int lentext) {
		return (int) functions.get("GetPlayer3DTextLabelText").call(playerid, id, text, lentext);
	}
	...
	public static float GetPlayer3DTextLabelDrawDist(int playerid, int id) {
	...
	public static int GetMenuColumnHeader(int menuid, int column, String header, int lenheader) {
		return (int) functions.get("GetMenuColumnHeader").call(menuid, column, header, lenheader);
	}

	public static int GetMenuItem(int menuid, int column, int itemid, String item, int lenitem) {
		return (int) functions.get("GetMenuItem").call(menuid, column, itemid, item, lenitem);
	}
	...
	public static int CreatePlayerPickup(int playerid, int model, int type, float X, float Y, float Z, int virtualworld) {
		return (int) functions.get("CreatePlayerPickup").call(playerid, model, type, X, Y, Z, virtualworld);
	}

	public static int DestroyPlayerPickup(int playerid, int pickupid) {
		return (int) functions.get("DestroyPlayerPickup").call(playerid, pickupid);
	}

	public static int IsValidPlayerPickup(int playerid, int pickupid) {
		return (int) functions.get("IsValidPlayerPickup").call(playerid, pickupid);
	}

	public static int IsPlayerPickupStreamedIn(int playerid, int pickupid) {
		return (int) functions.get("IsPlayerPickupStreamedIn").call(playerid, pickupid);
	}

	public static int GetPlayerPickupPos(int playerid, int pickupid, ReferenceFloat fX, ReferenceFloat fY, ReferenceFloat fZ) {
		return (int) functions.get("GetPlayerPickupPos").call(playerid, pickupid, fX, fY, fZ);
	}

	public static int GetPlayerPickupModel(int playerid, int pickupid) {
		return (int) functions.get("GetPlayerPickupModel").call(playerid, pickupid);
	}

	public static int GetPlayerPickupType(int playerid, int pickupid) {
		return (int) functions.get("GetPlayerPickupType").call(playerid, pickupid);
	}

	public static int GetPlayerPickupVirtualWorld(int playerid, int pickupid) {
		return (int) functions.get("GetPlayerPickupVirtualWorld").call(playerid, pickupid);
	}
