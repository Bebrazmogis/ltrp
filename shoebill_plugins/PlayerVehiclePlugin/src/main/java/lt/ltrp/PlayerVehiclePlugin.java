...
import lt.ltrp.dao.PlayerVehicleFineDao;
import lt.ltrp.dao.PlayerVehiclePermissionDao;
import lt.ltrp.business.dao.impl.MySqlPlayerVehicleArrestDaoImpl;
import lt.ltrp.business.dao.impl.MySqlPlayerVehicleDaoImpl;
import lt.ltrp.business.dao.impl.MySqlPlayerVehicleFineDaoImpl;
import lt.ltrp.business.dao.impl.MySqlPlayerVehiclePermissionDaoImpl;
import lt.ltrp.data.*;
import lt.ltrp.event.PlayerVehicleDestroyEvent;
...
// TODO
    ...
    public PlayerVehicle getByLicense(String license) {
        Optional<PlayerVehicle> op = PlayerVehicle.get().stream().filter(v -> v.getLicense().equals(license)).findFirst();
