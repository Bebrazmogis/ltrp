...
public interface PlayerVehicle extends LtrpVehicle {
    ...
    static List<PlayerVehicle> get() {
        return PlayerVehiclePlugin.get(PlayerVehiclePlugin.class).getVehicles();
    }

    static PlayerVehicle getByLicense(String license) {
        return PlayerVehiclePlugin.get(PlayerVehiclePlugin.class).getByLicense(license);
    }

    static PlayerVehicle getByVehicle(Vehicle vehicle) {
        return PlayerVehiclePlugin.get(PlayerVehiclePlugin.class).getByVehicle(vehicle);
    }
    ...
    static PlayerVehicle create(int id, int modelId, AngledLocation location, int color1, int color2, int ownerId,
        ...
        return PlayerVehiclePlugin.get(PlayerVehiclePlugin.class).createVehicle(id, modelId, location, color1, color2, ownerId, deaths, fueltank, mileage, license, insurance, alarm, lock, doors, panels, lights, tires, health, eventManager);
    }
