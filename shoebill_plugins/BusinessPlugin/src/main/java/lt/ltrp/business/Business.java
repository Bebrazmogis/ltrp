 ...
 *         2016.04.13.
 */
public interface xBusiness extends Property {
    ...
    static Business create(int id, BusinessType type, Location entrance, Location exit, int price) {
        return create(id, "", type, Entity.Companion.getINVALID_ID(), DEFAULT_PICKUP_MODEL, price, entrance, exit, DEFAULT_BUSINESS_LABEL_COLOR, 0, DEFAULT_RESOURCES, DEFAULT_COMMODITY_LIMIT);
    }

    static Business create(String name, Location entrance, Location exit, int price) {
        return create(0, name, BusinessType.None, Entity.Companion.getINVALID_ID(), DEFAULT_PICKUP_MODEL, price, entrance, exit, DEFAULT_BUSINESS_LABEL_COLOR, 0, DEFAULT_RESOURCES, DEFAULT_COMMODITY_LIMIT);
    }
