 ...
 *         2016.04.19.
 */
public class MySqlBusinessDaoImpl extends MySqlPropertyDaoImpl implements BusinessDao {
    
    private EventManager eventManager;

    public MySqlBusinessDaoImpl(DataSource dataSource, EventManager eventManager) {
        super(dataSource);
    ...
    @Override
    public Collection<Business> get() {
        Collection<Business> businesses = new ArrayList<>();
    ...
    private Business resultToBusiness(ResultSet r) throws SQLException {
        ...
        return new BusinessImpl(r.getInt("id"),
                r.getString("name"),
