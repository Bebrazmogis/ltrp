            ...
            ListDialog.create(player, eventManager)
                    ...
                    .item("Paðalinti prekæ ið pardavimo", () -> commodityList.size() > 0, i -> {
                        ...
                        AbstractDialog dialog = BusinessCommodityListDialog.create(player, eventManager, commodityList, (dd, p, c) -> {
                            ...
                            BusinessController.get().getBusinessDao().remove(t, c);
                            ...
                            Business.get().stream().filter(b -> b.getCommodities().contains(c)).forEach(b -> {
                                ...
                                if (commodity.isPresent())
                                    BusinessController.get().getBusinessDao().remove(commodity.get());
                            });
                                        ...
                                        InputDialog.create(player, eventManager)
                                                ...
                                                .onClickOk((dddd, name) -> {
                                                    if (name.isEmpty())
                                                        ...
                                                        BusinessController.get().getBusinessDao().insert(t, commodity);
                                    ...
                                    BusinessCommodityNameInputDialog.create(player, eventManager, ii.getCurrentDialog(), (nameDialog, name) -> {
                                        ListDialog.create(player, eventManager)
                                                ...
                                                .onClickOk((actionDialog, item) -> {
                                                    ...
                                                    BusinessController.get().getBusinessDao().insert(t, commodityDrink);
                                    ...
                                    InputDialog.create(player, eventManager)
                                            ...
                                            .onClickOk((dddd, name) -> {
                                                if (name.isEmpty())
                                                    ...
                                                    BusinessController.get().getBusinessDao().insert(t, new BusinessCommodity(0, name));
                            ...
                            InputDialog.create(player, eventManager)
                                    ...
                                    .onClickOk((ddd, name) -> {
                                        if (name.isEmpty())
                                            ...
                                            c.setName(name);
                                            BusinessController.get().getBusinessDao().update(c);
                                            Business.get().forEach(b -> {
                                                ...
                                                if (commodity.isPresent()) {
                                                    ...
                                                    BusinessController.get().getBusinessDao().update(commodity.get());
                                                }
                                            });
                                        }
                                    })
