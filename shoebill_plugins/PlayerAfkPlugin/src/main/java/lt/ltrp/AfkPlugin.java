...
import lt.ltrp.service.PlayerKickerService;
...
public class AfkPlugin extends Plugin {
    ...
    private PlayerKickerService kickerService;
    ...
    protected void onEnable() throws Throwable {
        ...
        kickerService = new PlayerKickerService(this);
        registerService(PlayerKickerService.class, kickerService);
    }
    ...
    protected void onDisable() throws Throwable {
        ...
        unregisterService(PlayerKickerService.class);
    }
