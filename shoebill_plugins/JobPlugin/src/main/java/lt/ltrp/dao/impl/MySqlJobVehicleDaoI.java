 ...
 *         2016.05.23.
 */
public class MySqlJobVehicleDaoI extends AbstractMySqlVehicleDaoImpl implements JobVehicleDao {


    public MySqlJobVehicleDaoI(DataSource ds, EventManager eventManager) {
