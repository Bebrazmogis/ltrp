...
import lt.ltrp.data.LicenseWarning;
...
public class PoliceCommands extends Commands {
    ...
    public PoliceCommands(PlayerCommandManager cmdmanger, PoliceFaction job, EventManager eventManager,
                          Map<JobVehicle, DynamicLabel> unitLabels, Map<JobVehicle, DynamicObject> sirends, Map<LtrpPlayer,DragTimer> dragtimers, PolicemanManager policemanager) {
