...
public class PlayerJobData {
    ...
    public PlayerJobData(LtrpPlayer player, Job job, Rank jobRank) {
        this.player = player;
        this.job = job;
    ...
    public PlayerJobData(LtrpPlayer player, Job job, Rank jobRank, int level, int xp, int hours, int remainingContract) {
        this.player = player;
        this.job = job;
        this.jobRank = jobRank;
        this.level = level;
