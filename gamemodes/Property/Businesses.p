...
static const ClothesShopCategories[][ E_CLOTHES_SHOP_CATEGORY_DATA ] =
{
    ...
    {15, "Árankiai ir laikomi objektai"}
};
...
{
    {1, ITEM_HoodyHat1,   19067, 180},
    {1, ITEM_HoodyHat2,   19068, 180},
    {1, ITEM_HoodyHat3,   19069, 180},
    {1, ITEM_SkullyCap1,  18964, 180},
    {1, ITEM_SkullyCap2,  18965, 180},
    {1, ITEM_SkullyCap3,  18966, 180},

    {2, ITEM_HatBowler1,  18944, 280},
    {2, ITEM_HatBowler2,  18945, 280},
    {2, ITEM_HatBowler3,  18946, 280},
    {2, ITEM_HatBowler4,  18950, 280},
    {2, ITEM_HatBowler5,  18951, 280},

    {3, ITEM_Beret1,      18921, 110},
    {3, ITEM_Beret2,      18922, 110},
    {3, ITEM_Beret3,      18923, 110},
    {3, ITEM_Beret4,      18924, 110},

    {4, ITEM_Mask1,       18911, 300},
    {4, ITEM_Mask2,       18912, 300},
    {4, ITEM_Mask3,       18913, 300},
    {4, ITEM_Mask4,       18914, 300},
    {4, ITEM_Mask5,       18915, 300},
    {4, ITEM_Mask6,       18916, 300},
    {4, ITEM_Mask7,       18917, 300},
    {4, ITEM_Mask8,       18918, 300},
    {4, ITEM_Mask9,       18919, 300},
    {4, ITEM_Mask10,      18920, 300},
    {4, ITEM_HockeyMask1, 19036, 300},
    {4, ITEM_HockeyMask2, 19037, 300},
    {4, ITEM_HockeyMask3, 19038, 300},
    {4, ITEM_MaskZorro1,  18974, 300},
    {4, ITEM_GimpMask1,   19163, 300},

    {5, ITEM_Bandana1,    18891, 80},
    {5, ITEM_Bandana2,    18892, 80},
    {5, ITEM_Bandana3,    18893, 80},
    {5, ITEM_Bandana4,    18894, 80},
    {5, ITEM_Bandana5,    18895, 80},
    {5, ITEM_Bandana6,    18896, 80},
    {5, ITEM_Bandana7,    18897, 80},
    {5, ITEM_Bandana8,    18898, 80},
    {5, ITEM_Bandana9,    18899, 80},
    {5, ITEM_Bandana10,   18900, 80},
    {5, ITEM_Bandana11,   18901, 80},
    {5, ITEM_Bandana12,   18902, 80},
    {5, ITEM_Bandana13,   18903, 80},
    {5, ITEM_Bandana14,   18904, 80},
    {5, ITEM_Bandana15,   18905, 80},

    {6, ITEM_GlassesType1,    19006, 160},
    {6, ITEM_GlassesType2,    19007, 160},
    {6, ITEM_GlassesType3,    19008, 160},
    {6, ITEM_GlassesType4,    19009, 160},
    {6, ITEM_GlassesType5,    19010, 160},
    {6, ITEM_GlassesType6,    19011, 160},
    {6, ITEM_GlassesType7,    19012, 160},
    {6, ITEM_GlassesType8,    19013, 160},
    {6, ITEM_GlassesType9,    19014, 160},
    {6, ITEM_GlassesType10,   19015, 160},
    {6, ITEM_GlassesType11,   19016, 160},
    {6, ITEM_GlassesType12,   19017, 160},
    {6, ITEM_GlassesType13,   19018, 160},
    {6, ITEM_GlassesType14,   19019, 160},
    {6, ITEM_GlassesType15,   19020, 160},

    {7, ITEM_BlackHat1,   18639, 200},
    {7, ITEM_CowboyHat1,  19095, 200},
    {7, ITEM_CowboyHat2,  18962, 200},
    {7, ITEM_CowboyHat3,  19096, 200},
    {7, ITEM_CowboyHat4,  19097, 200},
    {7, ITEM_CowboyHat5,  19098, 200},
    {7, ITEM_HatCool1,    18971, 200},
    {7, ITEM_HatCool2,    18972, 200},
    {7, ITEM_HatCool3,    18973, 200},
    {7, ITEM_HatTiger1,   18970, 200},

    {8, ITEM_MotorcycleHelmet2,   18976, 350},
    {8, ITEM_MotorcycleHelmet3,   18977, 350},
    {8, ITEM_MotorcycleHelmet4,   18978, 350},
    {8, ITEM_MotorcycleHelmet5,   18979, 350},

    {9, ITEM_Helmet1,        18936, 100},
    {9, ITEM_Helmet2,        18937, 100},
    {9, ITEM_Helmet3,        18938, 100},
    {9, ITEM_ArmyHelmet1,    19101, 100},
    {9, ITEM_ArmyHelmet2,    19102, 100},
    {9, ITEM_ArmyHelmet3,    19103, 100},
    {9, ITEM_ArmyHelmet4,    19104, 100},
    {9, ITEM_ArmyHelmet5,    19105, 100},
    {9, ITEM_ArmyHelmet6,    19106, 100},
    {9, ITEM_ArmyHelmet7,    19107, 100},
    {9, ITEM_ArmyHelmet8,    19108, 100},
    {9, ITEM_ArmyHelmet9,    19109, 100},
    {9, ITEM_ArmyHelmet10,   19110, 100},
    {9, ITEM_ArmyHelmet11,   19111, 100},
    {9, ITEM_ArmyHelmet12,   19112, 100},

    {10, ITEM_Hat1,         18926, 70},
    {10, ITEM_Hat2,         18927, 70},
    {10, ITEM_Hat3,         18928, 70},
    {10, ITEM_Hat4,         18929, 70},
    {10, ITEM_Hat5,         18930, 70},
    {10, ITEM_Hat6,         18931, 70},
    {10, ITEM_Hat7,         18932, 70},
    {10, ITEM_Hat8,         18933, 70},
    {10, ITEM_Hat9,         18934, 70},
    {10, ITEM_Hat10,        18935, 70},
    {10, ITEM_CapBack1,     18939, 70},
    {10, ITEM_CapBack3,     18940, 70},
    {10, ITEM_CapBack4,     18942, 70},
    {10, ITEM_CapBack5,     18943, 70},
    {10, ITEM_CapOverEye1,  18955, 70},
    {10, ITEM_CapOverEye2,  18956, 70},
    {10, ITEM_CapOverEye3,  18957, 70},
    {10, ITEM_CapOverEye4,  18958, 70},
    {10, ITEM_CapOverEye5,  18959, 70},

    /*{11, ITEM_HatMan1,
    {11, ITEM_HatMan2,
    {11, ITEM_HatMan3,
*/
    {12, ITEM_HardHat2,         19093, 160},
    {12, ITEM_HardHat3,         19160, 160},
    {12, ITEM_SillyHelmet1,     19113, 160},
    {12, ITEM_SillyHelmet2,     19114, 160},
    {12, ITEM_SillyHelmet3,     19115, 160},
    {12, ITEM_PlainHelmet1,     19116, 160},
    {12, ITEM_PlainHelmet2,     19117, 160},
    {12, ITEM_PlainHelmet3,     19118, 160},

    {13, ITEM_BurgerShotHat1,  19094, 65},
    {13, ITEM_CluckinBellHat1, 19137, 65},

    {14, ITEM_pilotHat01,  19520, 500},
    {14, ITEM_pilotHat02,  19521, 500},
    {14, ITEM_fire_hat01,  19330, 500},
    {14, ITEM_fire_hat02,  19331, 500},
    {14, ITEM_PoliceCap1,  18636, 500},
    {14, ITEM_PoliceCap2,  19099, 500},
    {14, ITEM_PoliceCap3,  19100, 500},

    {15, ITEM_GTASAWrench1,     18633, 200},
    {15, ITEM_GTASACrowbar1,    18634, 200},
    {15, ITEM_GTASAHammer1,     18635, 200},
    {15, ITEM_Flashlight1,      18641, 200},
    {15, ITEM_Taser1,           18642, 200},
    {15, ITEM_Screwdriver1,     18644, 200}
        ...
        case DIALOG_BIZ_WARE_LIST:
        {
            ...
            if(bInfo[ bizIndex ][ bType ] == Supermarket)
            {
				...
				switch(itemid)
				{
					...
					case ITEM_FUEL:
					{
						success = GivePlayerFuelTankItem(playerid, ITEM_FUEL);
					}
					...
					case ITEM_RODTOOL:
					{
						success = GivePlayerFishingBait(playerid, ITEM_RODTOOL, 20, 20);
					}
					case ITEM_FISH:
					{
						success = GivePlayerFishingBag(playerid, ITEM_FISH, 0, 100);
					}
...
stock DeleteBusinessFurniture(bizindex, furniture_index)
{
    ...
    new i;
    for(i = furniture_index; i < MAX_BUSINESS_FURNITURE-1; i++)
    {
        BusinessFurniture[ bizindex ][ i ] = BusinessFurniture[ bizindex ][ i + 1];
    }
