...
enum E_ITEM_DATA 
{
	...
	bool:IsContainer,
	bool:IsDegradable,
	bool:SellFull,				// Ar pardavinëti pilnus
	bool:SellMaxDurability, 
	ObjectModel,
	MaxDurability,
	MaxCapacity,
	UsageFunction[ 32 ],
...
stock static const ItemData[ ][ E_ITEM_DATA ] =
{
	...
	{ITEM_DRUGS,			"Medikamentai",								false, false, false, false, false, false, false,	0,		0,		0, "", NoParameters},
	{ITEM_HERAS,			"Heroinas",									true, false, true, false,  false, false, false,		0,		0,		1,	"OnPlayerUseHeroin", PlayerId | ItemId},
	...
	{ITEM_MEDLIC,			"Receptas",									false, false, false, false, false, false, false,	0,		0,		0, "", NoParameters},
	{ITEM_MEDIC,			"Receptiniai vaistai", 						false, false, false, false, false, false, false,	0,		0,	 	0, "", NoParameters},
	{ITEM_BEER,				"Butelis alaus",							false, false, false, false, false, false, false,	0,		0,		1, "OnPlayerUseBeer", PlayerId | ItemId },
	{ITEM_SPRUNK,			"Sprunk skardinë", 							false, false, false, false, false, false, false,	0,		0,		1, "OnPlayerUseSprunk", PlayerId | ItemId},
	{ITEM_VINE,				"Vynas",									false, false, false, false, false, false, false,	0,		0,	 	1, "OnPlayerUseVine", PlayerId | ItemId},
	{ITEM_PAPER,			"Laikraðtis",								false, false, false, false, false, false, false,	0,		0,		0, "", NoParameters},
	{ITEM_MOLOTOV,			"Degusis skystis",							false, false, false, false, false, false, false,	0,		0,		1,	"OnPlayerUseMolotov", PlayerId | ItemId},
	{ITEM_MP3,				"MP3 grotuvas",								false, false, false, false, false, false, false,	0,		0,	 	0,	"OnPlayerUseMP3Player", PlayerId | ItemId},
	{ITEM_MAGNETOLA,		"Automagnetola",							false, false, false, false, false, false, false,	0,		0,		0,	"", NoParameters},
	{ITEM_AUDIO,			"Namø audio sistema",						false, false, false, false, false, false, false,	0,		0,	 	1, "OnPlayerUseHouseAudio", PlayerId | ItemId},
	{ITEM_BIGAUDIO,			"Grotuvas",									false, false, false, false, false, false, false,	0,		0,		0,	"OnPlayerUseAudioPlayer", PlayerId | ItemId},
	{ITEM_TEORIJA,			"Teorijos lapas",							false, false, false, false, false, false, false,	0,		0,		0,	"",	NoParameters},
	{ITEM_ROADBLOCK,		"Kelio uþtvara", 							false, false, false, false, false, false, false,	0,		0,	 	0, "", NoParameters},
	...
	{ITEM_HatCool2, 		"Oranþinë/juoda skrybelë",					false, false, false, false, false, false, false, 	18972,	0,		0,	"OnPlayerUseHat", PlayerId | ItemId | InventoryIndex},
	{ITEM_HatCool3, 		"Geltona/juoda skrybelë",					false, false, false, false, false, false, false, 	18973,	0,		0,	"OnPlayerUseHat", PlayerId | ItemId | InventoryIndex},
	...
	{ITEM_pilotHat02, 		"Piloto kepurë",							false, false, false, false, false, false, false, 	19521,	0,		0,	"OnPlayerUseHat", PlayerId | ItemId | InventoryIndex},
	...
	{4,						"Peilis", 									false, true, false, false, false, false, false,	335,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex}, 
	{5, 					"Beisbolo lazda",							false, true, false, false, false, false, false,	336,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{6, 					"Kastuvas",									false, true, false, false, false, false, false,	337,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{7, 					"Pûlo lazda",								false, true, false, false, false, false, false,	338,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{8,						"Katana",									false, true, false, false, false, false, false,	339,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{9, 					"Benzininis pjûklas",						false, true, false, false, false, false, false,	341,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{10, 					"Vibratorius",								false, true, false, false, false, false, false,	321,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{11,					"Vibratorius",								false, true, false, false, false, false, false,	322,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{12,					"Vibratorius",								false, true, false, false, false, false, false,	323,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{13,					"Vibratorius",								false, true, false, false, false, false, false,	324,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{14,					"Gëliø puokðtë",							false, true, false, false, false, false, false,	325,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{15, 					"Lazda",									false, true, false, false, false, false, false,	326,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{16,					"Granata",									false, true, false, false, false, false, false,	342,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{17, 					"Aðarinës dujos",							false, true, false, false, false, false, false,	343,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{18,					"Moltov kokteilis",							false, true, false, false, false, false, false,	344,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{22,					"9mm pistoletas",							false, true, false, false, false, false, false,	346,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{23,					"9mm pistoletas(duslintuvas)",				false, true, false, false, false, false, false,	347,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{24,					"Desert Eagle",								false, true, false, false, false, false, false,	348,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{25, 					"Shotgun",									false, true, false, false, false, false, false,	349,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{26,					"Nupjautas Shotgun",						false, true, false, false, false, false, false,	350,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{27,					"Combat Shotgun",							false, true, false, false, false, false, false,	351,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{28,					"Micro SMG",								false, true, false, false, false, false, false,	352,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{29,					"MP5",										false, true, false, false, false, false, false,	353,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{30,					"AK-47",									false, true, false, false, false, false, false,	355,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{31,					"M4",										false, true, false, false, false, false, false,	356,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{32,					"Tec-9",									false, true, false, false, false, false, false,	372,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{33, 					"Rifle",									false, true, false, false, false, false, false,	357,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{34, 					"Sniper",									false, true, false, false, false, false, false,	358,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{35,					"Raketsvaidis",								false, true, false, false, false, false, false,	359,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{36,					"Raketsvaidis",								false, true, false, false, false, false, false,	360,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{37,					"Ugniasvaidis",								false, true, false, false, false, false, false,	361,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{38,					"Minigun",									false, true, false, false, false, false, false,	362,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{39,					"Daiktas",									false, true, false, false, false, false, false,	363,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{40,					"Detonatorius",								false, true, false, false, false, false, false,	364,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{41,					"Purðkiami daþai",							false, true, false, false, false, false, false,	365,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{42,					"Gesintuvas",								false, true, false, false, false, false, false,	366,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
	{43,					"Kamera",									false, true, false, false, false, false, false,	367,	0,		0, "OnPlayerUseWeapon", PlayerId | ItemId | InventoryIndex},
