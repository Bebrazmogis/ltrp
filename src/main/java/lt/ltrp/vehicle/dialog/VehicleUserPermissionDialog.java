...
public class VehicleUserPermissionDialog extends PageListDialog{
    ...
    public VehicleUserPermissionDialog(LtrpPlayer player, EventManager eventManager, PlayerVehicle vehicle, int userId) {
        super(player, eventManager);
        this.username = LtrpGamemode.getDao().getPlayerDao().getUsername(userId);
        this.userId = userId;
