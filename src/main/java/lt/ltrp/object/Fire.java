...
public class Fire implements Destroyable {
    ...
    private DynamicSampObject fireObjects[];
    ...
    private Fire(LtrpPlayer starter, int explosionType, Location center, int fireCount, int explosionCount) {
        ...
        this.fireObjects = new DynamicSampObject[fireCount];
        ...
        for(int i = 0; i < fireCount; i++) {
            ...
            fireObjects[i] = DynamicSampObject.create(DEFAULT_FIRE_MODEL, location, 0.0f, 0.0f, 0.0f);
        }
