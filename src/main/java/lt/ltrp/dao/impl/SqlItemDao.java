...
*/
    ...
    private String getLocationTable(InventoryEntity entity) {
        if(entity.getClass().equals(LtrpPlayer.class)) {
            return "player_items";
        } else if(entity.getClass().equals(Property.class)) {
            return "property_items";
        } else if(entity.getClass().equals(LtrpVehicle.class)) {
    ...
    private lt.ltrp.item.object.Item getItem(ResultSet r) throws SQLException {
        ...
        switch(typeClass) {
            case "lt.ltrp.item.AmphetamineItem":
                ...
                break;
            case "lt.ltrp.item.WeedItem":
                item = new WeedItem(id, name, eventManager, doses);
                break;
            case "lt.ltrp.item.CocaineItem":
            ...
            case "lt.ltrp.item.EctazyItem":
                ...
                break;
            case "lt.ltrp.item.DrinkItem":
                item = new DrinkItem(id, name, eventManager, type, doses, action);
                break;
            case "lt.ltrp.item.MolotovItem":
                item = new MolotovItem(id, name, eventManager);
                break;
            case "lt.ltrp.item.ToolboxItem":
