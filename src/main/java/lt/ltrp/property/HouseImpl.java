 ...
 *         2015.11.29.
 */
public class HouseImpl extends PropertyImpl implements House {
    ...
    public static House create(int uniqueid, String name, Location entrance, Location exit, EventManager eventManager) {
        House property = new HouseImpl(uniqueid, name, eventManager);
    ...
    public HouseImpl(int uniqueid, String name, EventManager manager) {
