...
class Callbacks {
    ...
    public static void registerHandlers(AmxInstanceManager instanceManager) {
        ...
        instanceManager.hookCallback("OnDynamicObjectMoved", new Consumer<AmxCallEvent>() {
            @Override
            public void accept(AmxCallEvent amxCallEvent) {
		...
		instanceManager.hookCallback("OnPlayerEditDynamicObject", new Consumer<AmxCallEvent>() {
            @Override
            public void accept(AmxCallEvent amxCallEvent) {
		...
		instanceManager.hookCallback("OnPlayerSelectDynamicObject", new Consumer<AmxCallEvent>() {
            @Override
            public void accept(AmxCallEvent amxCallEvent) {
                int playerid = (int) amxCallEvent.getParameters()[0];
                int objectid = (int) amxCallEvent.getParameters()[1];
		...
		instanceManager.hookCallback("OnPlayerShootDynamicObject", new Consumer<AmxCallEvent>() {
            @Override
            public void accept(AmxCallEvent amxCallEvent) {
                int playerid = (int) amxCallEvent.getParameters()[0];
		...
		instanceManager.hookCallback("OnPlayerPickUpDynamicPickup", new Consumer<AmxCallEvent>() {
            @Override
            public void accept(AmxCallEvent amxCallEvent) {
                int playerid = (int) amxCallEvent.getParameters()[0];
		...
		instanceManager.hookCallback("OnPlayerEnterDynamicCP", new Consumer<AmxCallEvent>() {
            @Override
            public void accept(AmxCallEvent amxCallEvent) {
                int playerid = (int) amxCallEvent.getParameters()[0];
		...
		instanceManager.hookCallback("OnPlayerLeaveDynamicCP", new Consumer<AmxCallEvent>() {
            @Override
            public void accept(AmxCallEvent amxCallEvent) {
                int playerid = (int) amxCallEvent.getParameters()[0];
                int checkpointid = (int) amxCallEvent.getParameters()[1];
		...
		instanceManager.hookCallback("OnPlayerEnterDynamicRaceCP", new Consumer<AmxCallEvent>() {
            @Override
            public void accept(AmxCallEvent amxCallEvent) {
                int playerid = (int) amxCallEvent.getParameters()[0];
                int checkpointid = (int) amxCallEvent.getParameters()[1];
		...
		instanceManager.hookCallback("OnPlayerLeaveDynamicRaceCP", new Consumer<AmxCallEvent>() {
            @Override
            public void accept(AmxCallEvent amxCallEvent) {
                int playerid = (int) amxCallEvent.getParameters()[0];
                int checkpointid = (int) amxCallEvent.getParameters()[1];
		...
		instanceManager.hookCallback("OnPlayerEnterDynamicArea", new Consumer<AmxCallEvent>() {
            @Override
            public void accept(AmxCallEvent amxCallEvent) {
                int playerid = (int) amxCallEvent.getParameters()[0];
		...
		instanceManager.hookCallback("OnPlayerLeaveDynamicArea", new Consumer<AmxCallEvent>() {
            @Override
            public void accept(AmxCallEvent amxCallEvent) {
                int playerid = (int) amxCallEvent.getParameters()[0];
                int areaid = (int) amxCallEvent.getParameters()[1];
		...
		instanceManager.hookCallback("Streamer_OnPluginError", new Consumer<AmxCallEvent>() {
            @Override
            public void accept(AmxCallEvent amxCallEvent) {
