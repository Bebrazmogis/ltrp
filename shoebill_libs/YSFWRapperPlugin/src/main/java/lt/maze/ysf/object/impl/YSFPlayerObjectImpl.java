...
import lt.maze.ysf.object.YSFPlayerObject;
...
public class YSFPlayerObjectImpl extends YSFPlayerObject {
    ...
    public YSFPlayerObjectImpl(PlayerObject object) {
        this.object = object;
    }
    ...
    private void getAttachedOffsetData() {
        ...
        Functions.GetPlayerObjectAttachedOffset(object.getPlayer().getId(), object.getId(), x, y, z, rx, ry, rz);
    ...
    public float getMoveSpeed() {
        return Functions.GetPlayerObjectMoveSpeed(object.getPlayer().getId(), object.getId());
    }
    ...
    public ObjectMaterial getMaterial(int index) {
        ...
        Functions.GetPlayerObjectMaterial(object.getPlayer().getId(), object.getId(), index, model, txd, txd.getLength(), texture, texture.getLength(), color);
    ...
    public ObjectMaterialText getMaterialText(int index) {
        ...
        Functions.GetPlayerObjectMaterialText(object.getPlayer().getId(), object.getId(), index, text, text.getLength(), size, font, font.getLength(), fontsize, bold, fontcolor, bgcolor, align);
    ...
    public boolean isNoCameraCol() {
        return Functions.IsPlayerObjectNoCameraCol(object.getPlayer().getId(), object.getId()) != 0;
    }
    ...
    public void setPlayerObjectNoCameraCol() {
        object.setPlayerObjectNoCameraCol();
    }
    ...
    public YSFObjectMaterialSlotUse isMaterialSlotUsed(int materialIndex) {
        return YSFObjectMaterialSlotUse.get(Functions.IsPlayerObjectMaterialSlotUsed(object.getPlayer().getId(), object.getId(), materialIndex));
    }

    @Override
    public int getObjectType() {
        return Functions.GetObjectType(object.getPlayer().getId(), object.getId());
    }
